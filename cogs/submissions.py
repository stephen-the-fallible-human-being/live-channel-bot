...
class Submissions(commands.Cog):
    ...
    @app_commands.command(name="setup_submit", description="Send a button for YouTube video submissions")
    async def setup_submit(self, interaction: discord.Interaction):
        embed = discord.Embed(
